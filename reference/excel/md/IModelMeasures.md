...
- `Item(Index As Variant, RHS As ModelMeasure)`
- `Add(MeasureName As String, AssociatedTable As ModelTable, Formula As String, FormatInformation As Variant, [Description As Variant], RHS As ModelMeasure)`

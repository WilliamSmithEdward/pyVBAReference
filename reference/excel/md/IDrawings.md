...
- `Reshape(Vertex As Long, Insert As Boolean, [Left As Variant], [Top As Variant], RHS As Variant)`
- `Add(X1 As Double, Y1 As Double, X2 As Double, Y2 As Double, Closed As Boolean, RHS As Drawing)`

...
- `setOption(option As SERVERXMLHTTP_OPTION, value As Variant)`  
  Set an option value
- `setProxy(proxySetting As SXH_PROXY_SETTING, [varProxyServer As Variant], [varBypassList As Variant])`  
  Specify proxy configuration
- `setProxyCredentials(bstrUserName As String, bstrPassword As String)`  

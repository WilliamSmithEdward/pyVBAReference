...
- `uniqueID(pNode As IXMLDOMNode) As Long`
- `depth(pNode As IXMLDOMNode) As Long`
- `childNumber(pNode As IXMLDOMNode) As Long`
- `ancestorChildNumber(bstrNodeName As String, pNode As IXMLDOMNode) As Long`
- `absoluteChildNumber(pNode As IXMLDOMNode) As Long`
- `formatIndex(lIndex As Long, bstrFormat As String) As String`
- `formatNumber(dblNumber As Double, bstrFormat As String) As String`
- `formatDate(varDate As Variant, bstrFormat As String, [varDestLocale As Variant]) As String`
- `formatTime(varTime As Variant, bstrFormat As String, [varDestLocale As Variant]) As String`

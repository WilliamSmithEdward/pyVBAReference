...
- `AddItem(Text As Variant, [Index As Variant]) As Variant`
- `RemoveAllItems() As Variant`
- `RemoveItem(Index As Long, [Count As Variant]) As Variant`
- `Add(Left As Double, Top As Double, Width As Double, Height As Double) As ListBox`

...
- `Add([Button As Variant], [Before As Variant], [OnAction As Variant], [Pushed As Variant], [Enabled As Variant], [StatusBar As Variant], [HelpFile As Variant], [HelpContextID As Variant], RHS As ToolbarButton)`

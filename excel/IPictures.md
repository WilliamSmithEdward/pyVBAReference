...
- `Add(Left As Double, Top As Double, Width As Double, Height As Double, RHS As Picture)`
- `Group(RHS As GroupObject)`
- `Insert(Filename As String, [Converter As Variant], RHS As Picture)`
- `Item(Index As Variant, RHS As Object)`
- `_NewEnum(RHS As IUnknown)`
- `Paste([Link As Variant], RHS As Picture)`

...
- `Close()`
- `Execute(CommandText As String, [RecordsAffected As Variant], [Options As Long]) As _Recordset_Deprecated`
- `BeginTrans() As Long`
- `CommitTrans()`
- `RollbackTrans()`
- `Open([ConnectionString As String], [UserID As String], [Password As String], [Options As Long])`
- `OpenSchema(Schema As SchemaEnum, [Restrictions As Variant], [SchemaID As Variant]) As _Recordset_Deprecated`
- `Cancel()`

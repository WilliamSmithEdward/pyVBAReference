...
- `getAttribute(name As String) As Variant`  
  look up the string value of an attribute by name
- `setAttribute(name As String, value As Variant)`  
  set the string value of an attribute by name
- `removeAttribute(name As String)`  
  remove an attribute by name
- `getAttributeNode(name As String) As IXMLDOMAttribute`  
  look up the attribute node by name
- `setAttributeNode(DOMAttribute As IXMLDOMAttribute) As IXMLDOMAttribute`  
  set the specified attribute on the element
- `removeAttributeNode(DOMAttribute As IXMLDOMAttribute) As IXMLDOMAttribute`  
